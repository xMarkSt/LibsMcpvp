...
public class Fisherman extends AbilityListener implements Disableable {
    ...
    public String[] junk = new String[] { "ACTIVATOR_RAIL", "ANVIL", "APPLE", "ARROW", "BAKED_POTATO", "BEACON", "BED",
            "BIRCH_STAIRS", "BLAZE_POWDER", "BLAZE_ROD", "BOAT", "BONE", "BOOK", "BOOK_AND_QUILL", "BOOKSHELF", "BOW",
            ...
            "MELON_STEM", "MILK_BUCKET", "MINECART", "MOSSY_COBBLESTONE", "LEGACY_MUSHROOM_SOUP", "MYCEL", "NETHER_BRICK_ITEM",
